...
<head>
  ...
  <title>Preventive Medical Category Bootstrap Responsive Template | Home :: W3Layouts</title>
  <link href="//fonts.googleapis.com/css?family=Nunito:400,600,700&display=swap" rel="stylesheet">
  <!-- Template CSS -->
  <link rel="stylesheet" href="https://tpowep.com/shahieen/assets/css/style-starter.css">
</head>
...
<body>
    ...
    <div class="container py-md-5 py-3">
      <div class="row bottom-ab-grids align-items-center">
        ...
        <div class="col-lg-6 bottom-ab-right mt-lg-0 mt-5 pl-lg-4">
          <img src="https://tpowep.com/shahieen/assets/images/2.jpg" alt="" class="img-fluid">
        </div>
    ...
    <div class="container py-md-5 py-3">
      <div class="cwp4-two row align-items-center">
        <div class="cwp4-image col-lg-6 pr-lg-5">
          <img src="https://tpowep.com/shahieen/assets/images/6.jpg" class="img-fluid" alt="">
        </div>
      ...
      <div class="row grid-view">
        ...
        <div class="col-lg-7 mt-lg-0 mt-4">
          <div class="row grids5-info">
            <div class="col-6">
              <a href="#" class="zoom">
                <img src="https://tpowep.com/shahieen/assets/images/s1.jpg" alt="" class="img-fluid" />
              </a>
            </div>
            <div class="col-6">
              <a href="#" class="zoom">
                <img src="https://tpowep.com/shahieen/assets/images/s2.jpg" alt="" class="img-fluid" />
              </a>
            </div>
          </div>
        </div>
      ...
      <div class="owl-news owl-carousel owl-theme">
        <div class="item">
          <div class="news-img position-relative">
            <a href="#"><img src="https://tpowep.com/shahieen/assets/images/1.jpg" class="img-fluid" alt="news image"></a>
        ...
        <div class="item">
          <div class="news-img">
            <a href="#"><img src="https://tpowep.com/shahieen/assets/images/2.jpg" class="img-fluid" alt="news image"></a>
            <div class="title-wrap">
              <a href="#">
        ...
        <div class="item">
          <div class="news-img">
            <a href="#"><img src="https://tpowep.com/shahieen/assets/images/3.jpg" class="img-fluid" alt="news image"></a>
            <div class="title-wrap">
              <a href="#">
        ...
        <div class="item">
          <div class="news-img">
            <a href="#"><img src="https://tpowep.com/shahieen/assets/images/4.jpg" class="img-fluid" alt="news image"></a>
            <div class="title-wrap">
              <a href="#">
        ...
        <div class="item">
          <div class="news-img">
            <a href="#"><img src="https://tpowep.com/shahieen/assets/images/5.jpg" class="img-fluid" alt="news image"></a>
            <div class="title-wrap">
              <a href="#">
        ...
        <div class="item">
          <div class="news-img">
            <a href="#"><img src="https://tpowep.com/shahieen/assets/images/6.jpg" class="img-fluid" alt="news image"></a>
            <div class="title-wrap">
              <a href="#">
  ...
  <script src="https://tpowep.com/shahieen/assets/js/jquery.waypoints.min.js"></script>
  <script src="https://tpowep.com/shahieen/assets/js/jquery.countup.js"></script>
  <script>
    $('.counter').countUp();
  </script>
  <!-- //stats number counter -->
  ...
  <script src="https://tpowep.com/shahieen/assets/js/bootstrap.min.js"></script>
