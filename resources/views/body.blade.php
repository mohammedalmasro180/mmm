...
@import url(https://fonts.google.com/share?selection.family=Cairo:wght@900%7CLalezar);

</style>
  <!-- Template CSS -->
  <link rel="stylesheet" href="assets/css/ar.css">
  <link rel="preconnect" href="https://fonts.gstatic.com" crossorigin>
<link href="https://fonts.googleapis.com/css2?family=Cairo:wght@900&family=Lalezar&family=Lemonada:wght@300&display=swap" rel="stylesheet">
...
<input type = "hidden" name = "_token" value = "<?php echo csrf_token(); ?>">
  <!--header-->
  <section class="w3l-header" dir="rtl">
            ...
            <div class="top-header-left">
              ...
              <ul class="info-top-gridshny">
                ...
                <li class="info-grid">
                  ...
                  <div class="info-text">
                    <p>TEL : +966 538088184</p>
                    <p>ALT : +966 59209811</p>
                  </div>
...
المملكة العربية السعودية – الرياض الريل 12321-5578
      ...
      <div class="header-2hny py-3">
        <div class="container">
          <nav class="navbar navbar-expand-lg navbar-dark stroke">
            <h1><a class="navbar-brand mr-xl-5 " href="/ar">
            <img src="assets/images/logo.png" width="200px" higth="200px" />
              </a></h1>
        ...
        <img src="image-path" alt="Your logo" title="Your logo" style="height:35px;" />
            ...
            <div class="collapse navbar-collapse" id="navbarTogglerDemo02">
              ...
              <li class="nav-item active">
                ...
                <li class="nav-item">
                  <a class="nav-link" href="#about">تعرف على الشاهين</a>
                </li>
                <li class="nav-item">
                  <a class="nav-link" href="#services">خدماتنا</a>
                </li>
                <li class="nav-item">
                  <a class="nav-link" href="/arcon">اتصل بنا</a>
                </li>
      ...
      <div class="container py-lg-4">
        <div class="row footer-top-29">
          <div class="col-lg-4 col-md-6 col-sm-7 footer-list-29 footer-1 pr-lg-5">
            ...
            <img src="assets/images/logo.jfif" width="250px" higth="250px" />
            </div>
            <p>
...
منذ أسس الأخوان Gray شركة شاهين منذ حوالي 100 عام، بنينا الشركة على أساس فكرة أن التصميم الهندسي الرائع والتصنيع الدقيق يقودان إلى المنتجات عالية الجودة وطويلة الأمد. يعلم عملاؤنا أن وراء كل منتج نقوم بتسليمه التزامًا منّا بتقديم خدمة عملاء استثنائية
          ...
          <div class="col-lg-4 col-md-6 col-sm-7 footer-list-29 footer-4 mt-lg-0 mt-5">
            <h6 class="footer-title-29">معلومات الشاهين</h6>
            <p class="mb-3">نحن هنا لمساعدتك
ما عليك سوى إجراء اتصال هاتفي أو إرسال رسالة بريد إلكتروني 
<br />
للحصول على خدمة العملاء الممتازة لأي من منتجات 
شاهين
</p>
            <p><strong>العنوان :</strong> المملكة العربية السعودية 
            <br /> الرياض الريل 12321-5578</p>
            <p class="my-2"><strong>الهاتف :</strong> <a href="">
            TEL : +966 538088184
            <p>
ALT : +966 59209811
</p>
